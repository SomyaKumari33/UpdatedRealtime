sap.ui.define(
  ...
  function (JSONModel, PluginViewController, Log, MessageBox, ErrorHandler) {
    ...
    var oPluginViewController = PluginViewController.extend('company.custom.plugins.realtimedashboard.massOperatorAssignmentPlugin.controller.PluginView', {
      ...
      onInit: function () {
        ...
        if (PluginViewController.prototype.onInit) {
          ...
          .prototype.onInit.apply(this, arguments);
     ...
     */
      ...
      onOrderInputChange: function (oEvent) {
        ...
        if (bIsDirty) {
          ...
          this._saveCurrentOrderData().then(function () {
     ...
     */
      ...
      _getBomData: function (sBomId, sBomType = 'SHOP_ORDER') {
        ...
        return new Promise((resolve, reject) => {
          ...
          this.ajaxGetRequest(sUrl, oParameters, function (oData) {
