sap.ui.define(['sap/ui/model/resource/ResourceModel', 'sap/dm/dme/podfoundation/control/PropertyEditor'], function(
  ...
  return PropertyEditor.extend('company.custom.plugins.realtimedashboard.materialConsumptionPlugin.builder.PropertyEditor', {
    constructor: function(sId, mSettings) {
      PropertyEditor.apply(this, arguments);
      this.setI18nKeyPrefix('materialConsumptionConfig.');
      this.setResourceBundleName('company.custom.plugins.realtimedashboard.materialConsumptionPlugin.i18n.builder');
      this.setPluginResourceBundleName('company.custom.plugins.realtimedashboard.materialConsumptionPlugin.i18n.i18n');
    },
