sap.ui.define([
  ...
  "company/custom/plugins/realtimedashboard/materialConsumptionPlugin/controller/ComponentBrowse",
  ...
  var BomBrowseType = BrowseBase.extend("company.custom.plugins.realtimedashboard.materialConsumptionPlugin.controller.BomBrowse", {
  ...
  return {
      ...
      open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
          return new BomBrowseType("bomBrowse", {
              ...
              oModel: oModel,
              sFragmentName: "company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.browse.BomBrowse",
