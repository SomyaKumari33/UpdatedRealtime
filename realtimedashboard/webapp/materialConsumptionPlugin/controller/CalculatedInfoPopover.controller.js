sap.ui.define([
    ...
    var CalculatedInfoPopoverType = BaseObject.extend("company.custom.plugins.realtimedashboard.materialConsumptionPlugin.controller.CalculatedInfoPopover", {
        ...
        constructor: function (sId, mSettings) {
            ...
            if (!this._oCalculatedInfoPopoverView) {
                this._oCalculatedInfoPopoverView = sap.ui.xmlfragment(this._sBaseId, "company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.CalculatedInfo", this);
