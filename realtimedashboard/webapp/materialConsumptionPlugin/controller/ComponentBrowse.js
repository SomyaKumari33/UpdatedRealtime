sap.ui.define([
    ...
    var ComponentBrowseType = BrowseBase.extend("company.custom.plugins.realtimedashboard.materialConsumptionPlugin.controller.ComponentBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback) {
            return new ComponentBrowseType("componentBrowse", {
                sFragmentName: "company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.ComponentBrowse",
