sap.ui.define([
    ...
    "company/custom/plugins/realtimedashboard/materialConsumptionPlugin/controller/BomBrowse",
    "company/custom/plugins/realtimedashboard/materialConsumptionPlugin/controller/RoutingBrowse"
], function (BrowseBase, JSONModel, StatusFormatter, ObjectTypeFormatter, BomBrowse, RoutingBrowse) {
    "use strict";

    var MaterialBrowseType = BrowseBase.extend("company.custom.plugins.realtimedashboard.materialConsumptionPlugin.controller.MaterialBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback) {
            return new MaterialBrowseType("materialBrowse", {
                ...
                sFragmentName: "company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.browse.materialBrowse",
