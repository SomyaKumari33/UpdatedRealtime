sap.ui.define(
  [
    ...
    'sap/m/MessageBox',
    'company/custom/plugins/realtimedashboard/materialConsumptionPlugin/controller/MaterialBrowse',
    'company/custom/plugins/realtimedashboard/materialConsumptionPlugin/controller/CalculateDialog.controller',
    'sap/dm/dme/controller/FormulaCalculatedInfo.controller',
    'company/custom/plugins/realtimedashboard/materialConsumptionPlugin/controller/StorageLocationBrowse',
    ...
    'company/custom/plugins/realtimedashboard/materialConsumptionPlugin/controller/WeighDispenseHandler',
  ...
  function(
    ...
    'use strict';
    var oLogger = Logging.getLogger('company.custom.plugins.realtimedashboard.materialConsumptionPlugin.controller.PluginView');
    return ListPluginViewController.extend('company.custom.plugins.realtimedashboard.materialConsumptionPlugin.controller.PluginView', {
      types: {
      ...
      showDetailsOfComponent: function(oEvent) {
        ...
        if (!this.byId('postingsDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.PostingsDialog',
            controller: this
      ...
      showStorageLocationDetails: function(oEvent) {
        ...
        if (!this.byId('storageLocationDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.StorageLocationDialog',
            controller: this
          }).then(function(oDialog) {
            oView.addDependent(oDialog);
            oDialog.open();
      ...
      showBatchDetails: function(oEvent) {
        ...
        if (!this.byId('batchDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.BatchDialog',
            controller: this
          }).then(
            function(oDialog) {
              oDialog.setEscapeHandler(
      ...
      openMaterialConsumptionPopup: function(oView) {
        if (!this.byId('consumeDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.ConsumeDialog',
            controller: this
          }).then(
            function(oDialog) {
              oDialog.setEscapeHandler(
      ...
      setDataToModelAndPostGi: function(oModel) {
        ...
        //   Sfc: this.consumeData.sfc,
        // ProOrder: this.consumeData.ProOrder,
        // PackMat: this.consumeData.PackMat,
        // PackMatDesc: this.consumeData.PackMatDesc,
        // PackUnitId: this.consumeData.PackUnitId,
        // HeaderMat: this.consumeData.HeaderMat,
        // HeaderMatDesc: this.consumeData.HeaderMatDesc,
        // BatchId: this.consumeData.BatchId,
        // Alleregnes: this.consumeData.Alleregnes,
        // ProdDate: this.consumeData.ProdDate,
        // BatchExpDate: this.consumeData.BatchExpDate,
        // Uom: this.consumeData.Uom,
        // ReceivedDT: this.consumeData.ReceivedDT,
        // PackedDT: this.consumeData.PackedDT,
        // ByProComp: this.consumeData.ByProComp,
        // ByProDesc: this.consumeData.ByProDesc

        Sfc : "A",
        ProOrder : "230000002288",
        PackMat : "ABC",
        PackMatDesc : "ABC",
        PackUnitId : "PC",
        HeaderMat : "HEADER",
        HeaderMatDesc : "DESCR",
        BatchId : "ID",
        Alleregnes : "COOL, LIST",
        ProdDate : "\/Date(1736899200000)\/",
        BatchExpDate : "\/Date(1736899200000)\/",
        Uom : "PC",
        ReceivedDT : "",
        PackedDT : "",
        ByProComp : "PRODUCT",
        ByProDesc : "DESCRIPTION"
      };

      //!Uncomment below code in POD
      var sURL = 'https://djn-s4dev.daajan.com:44300/sap/opu/odata/sap/ZDM_PACKING_CPI_SRV/ZDM_PACKINGSet?$format=json';
	...
	@@ -2469,14 +2527,26 @@ sap.ui.define([
      ...
      openAddDialog: function() {
        ...
        if (!this.byId('addDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.AddMaterial',
            controller: this
          }).then(
            function(oDialog) {
              oDialog.setEscapeHandler(
      ...
      openScanDialog: function() {
        ...
        if (!this.byId('scanDialog')) {
          ...
          Fragment.load({
            id: oView.getId(),
            name: 'company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.ScannerDialog',
            controller: this
          }).then(
            function(oDialog) {
      ...
      onFindHUInv: function() {
        ...
        Fragment.load({
          id: oView.getId(),
          name: 'company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.HandlingUnitDialog',
          controller: this
        }).then(function(oDialog) {
          oView.addDependent(oDialog);
          oDialog.open();
      ...
      onPressViewAlternateBoms: function(oEvent) {
        ...
        if (!this.byId('alternateComponentsDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.AlternateComponentsDialog',
            controller: this
          }).then(function(oDialog) {
            oDialog.setEscapeHandler(
              function(oPromise) {
