sap.ui.define([
    ...
    "company/custom/plugins/realtimedashboard/materialConsumptionPlugin/controller/ListFilterRoutingBrowse"
], function (JSONModel, BrowseBase, StatusFormatter, ObjectTypeFormatter, ListFilterRoutingBrowse) {
    "use strict";

    var RoutingBrowseType = BrowseBase.extend("company.custom.plugins.realtimedashboard.materialConsumptionPlugin.controller.RoutingBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new RoutingBrowseType("routingBrowse", {
                oModel: oModel,
                sFragmentName: "company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.browse.RoutingBrowse",
