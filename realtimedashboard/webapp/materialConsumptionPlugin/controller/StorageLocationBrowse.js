sap.ui.define([
    ...
    "company/custom/plugins/realtimedashboard/materialConsumptionPlugin/utils/formatter"
], function (BrowseBase, Formatter) {
    "use strict";

    var StorageLocationBrowseType = BrowseBase.extend("company.custom.plugins.realtimedashboard.materialConsumptionPlugin.controller.StorageLocationBrowse", {
        formatter: Formatter,
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new StorageLocationBrowseType("storageLocationBrowse", {
                oModel: oModel,
                sFragmentName: "company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.browse.StorageLocationsBrowse",
        ...
        openMulti: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
             return new StorageLocationBrowseType("storageLocationBrowse", {
                oModel: oModel,
                sFragmentName: "company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.browse.StorageLocationsBrowseMulti",
                oParentControl: oParentControl,
                sDefaultSearchValue: sDefaultSearchValue,
                fnSelectionCallback: fnSelectionCallback,
                oFilterSettings: {
