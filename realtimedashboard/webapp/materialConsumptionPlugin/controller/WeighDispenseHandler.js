sap.ui.define([
    "company/custom/plugins/realtimedashboard/materialConsumptionPlugin/controller/CommonConsumeHandler",
    "./../utils/formatter",
    ...
    "use strict";
    const oLogger = Logging.getLogger("company.custom.plugins.realtimedashboard.materialConsumptionPlugin.controller.WeighDispenseHandler");
    var WeighDispenseHandler = CommonConsumeHandler.extend("company.custom.plugins.realtimedashboard.materialConsumptionPlugin.controller.WeighDispenseHandler", {
        ...
        openWeighingDialog: function () {
            ...
            if (!oWeighingDialog) {
                let sPopupPath = "company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.WeighPopup";
                Fragment.load({
                    id: oView.getId(),
                    name: sPopupPath,
        ...
        openWeighingScanDialog: function () {
            ...
            if (!oScanWeighingDialog) {
                Fragment.load({
                    id: oView.getId(),
                    name: "company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.ScannerWeighDialog",
                    controller: this.oMaterialConsumptionController
                }).then(function (oDialog) {
        ...
        openWeighingAddDialog: function () {
            ...
            if (!oAddWeighingDialog) {
                Fragment.load({
                    id: oView.getId(),
                    name: "company.custom.plugins.realtimedashboard.materialConsumptionPlugin.view.fragments.AddWeighMaterial",
                    controller: this.oMaterialConsumptionController
                }).then(function (oDialog) {
